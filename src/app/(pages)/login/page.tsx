...
<Link href="/forgetPassword" className='block mt-3 font-semibold hover:text-green-700 transition-all duration-700 text-[20px]'>forget your password ?</Link>
      <Button className=' w-1/8 text-[20px] absolute right-100 cursor-pointer bg-transparent border-1 border-black text-gray-800 hover:bg-transparent '>Register</Button>
  </form>
</Form>
